...
public interface IUserTakeActivityCountDao {
     ...
     */
    @DBRouter(key = "uId")
    UserTakeActivityCount getUserTakeActivityCount(UserTakeActivityCount userTakeActivityCountReq);

    /**
     * 插入领取次数信息
     * @param userTakeActivityCount 请求入参
     */
    void insertUserTakeActivityCount(UserTakeActivityCount userTakeActivityCount);
