package com.glimound.lottery.domain.activity.service.stateflow.event;

import com.glimound.lottery.common.Constants;
import com.glimound.lottery.common.Result;
import com.glimound.lottery.domain.activity.service.stateflow.AbstractState;
...
public class ArraignmentState extends AbstractState {
    ...
    public Result close(Long activityId, Enum<Constants.ActivityState> currentState) {
        return Result.buildResult(Constants.ResponseCode.UNKNOWN_ERROR, "非拒绝活动不可关闭");
    }
